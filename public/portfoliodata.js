      ...
      HeroSection: 
        {
          ...
          "tagline": "I specialize in creating dynamic, responsive, and scalable web applications with expertise in the MERN stack. Let's build your vision!"
        },
      AboutSection:
        {
            tag:"About Me",
            heading:"Hello! I'm <span>Mehroz Farooq</span. A Professional <span>Web Developer & MERN Stack Specialist</span>",
        ...
        ServiceSection:{
            heading:"My Services",
            tagline:"I offer a variety of web and mobile development services, tailored to help businesses achieve their goals through innovative and efficient solutions.",
            service:[
                {
        ...
        EducationSection:{
            ...
            tagline:"I have a strong academic background in Information Technology and Computer Science, which has shaped my skills and knowledge in web development and software engineering.",
            education:[
                    {
                        startend:"2018 - 2020",
                        degree:" FSC Pre Engineering",
                        institute:"Aspire College, Mian Channu",
                        description: "Achieved 80% overall, with 92% in Mathematics, during my FSC Pre-Engineering at Aspire College, Mian Channu.",
                    },
                    {
                        startend:"2020 - 2024",
                        degree:"Bachelor of Science in Information Technology",
                        institute:"Bahauddin Zakariya University",
                        description: "Among the few who mastered coding and web development, creating outstanding projects during my studies at Bahauddin Zakariya University.",
        ...
        ExperienceSection:{
            ...
            tagline:" Experienced in web development with the MERN stack, collaborating with .NET developers to integrate RESTful APIs into frontend applications.",
            experience:[
                      {
                        startend: "2020 - 2021",
                        role: "Web Development Learner",
                        where: "Self-Study",
                        description: "I started my journey into web development by learning HTML, CSS, JavaScript, PHP, and SQL. Through self-paced learning and personal projects, I gained foundational skills in web development, which set the groundwork for my future career."
                      },
                      {
                        startend: "2021 - 2022",
                        role: "Frontend Developer Intern",
                        where: "MUX Institute",
                        description: "During my time at MUX Institute, I learned advanced web development concepts and worked as an intern as a frontend developer. I contributed to the development of web applications, enhanced UI/UX, and worked closely with senior developers to sharpen my skills."
                      },
                      {
                        startend: "2023 - 2024",
                        role: "MERN Stack Developer",
                        where: "WebTech Smart Solution",
                        description: "As a MERN Stack Developer at WebTech Smart Solution, I built dynamic web applications like a Smart Parking Solution, Tuition System, and Dashboards for students. I worked with APIs, handled both frontend and backend integrations, and collaborated with teams to deliver seamless user experiences."
                      },
                      {
                        startend: "2024 - Present",
                        role: "Frontend React Developer",
                        where: "EDUSoft System Solution",
                        description: "At EDUSoft, I work on internal projects such as the Employee Management System and Tag Printing. I add new functionalities like creating master-detail forms, applying filters, and enhancing UI elements. I also contribute to the development of a new project, the Account Management System, from scratch."
                      },
                      {
                        startend: "2024 - Present",
                        role: "Freelance Web Developer",
                        where: "Freelance",
                        description: "As a freelance web developer, I have worked on various client projects, including developing responsive websites, e-commerce platforms, and custom web applications. I leverage my expertise in frontend and backend technologies to deliver solutions that meet client needs and enhance user experience."
                      }
                    ]
        ...
        ProjectSection:{
            heading:"My Projects",
            tagline:"Here are some of the key projects I have worked on, showcasing my skills in web development and problem-solving.",
            project:[
                {
                    id:"1",
                    img: Project1,
                    ...
                    tags:["React","Nodejs","Expressjs","MongoDB"], 
                      projectData : {
                         ...
                         projectState:{
                            ...
                            description:"Discover the key metrics and insights behind the project, including its size, components, and development progress. This section highlights important figures that showcase the scale and impact of the project.",
                            img:Project2,
                            state:[
                                {
                                    title:"Line of code",
                        ...
                        //   ],
                        documentation:{
                            description:"Access detailed guides and resources to get the most out of the project. Our comprehensive documentation covers everything from setup to advanced features, ensuring you have all the information you need for a smooth experience",
                            img:Project1,
                        },
                          pricing:12000,
                          pricevalue:[
